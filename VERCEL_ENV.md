...
افتح https://kids-co-backlog.vercel.app واعمل **Hard Refresh** (Ctrl+Shift+R أو Cmd+Shift+R) عشان المتصفح مايستخدمش نسخة قديمة من الـ JS. بعد كده الطلبات تكون على `https://back.kidsndco.com/api`.
